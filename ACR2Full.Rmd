...
```
```{r star2autocorrTest, echo=T}
LMtest_STAR2autocorr(xt, d=2, c=0.131, gamma=10, par=c(-0.02606206, 0.3141173, 0.3861456, 0.1340813, 1.1096505, -0.5167062), pmax=9)
```
...
LMtest_STAR3nonLin(xt, d=2, c=0.131, gamma=10, par=c(-0.02606206, 0.3141173, 0.3861456, 0.1340813, 1.1096505, -0.5167062), pmax=13)
```
...
```{r predictPlot2, echo=T, fig.width=10, fig.height=4}
par(mfrow=c(1, 1))
predictSTAR_andPlot(
